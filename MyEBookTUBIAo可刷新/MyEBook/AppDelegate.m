...
{
    ViewController * firstVC=(ViewController *)[self creatVCWithClass:[ViewController class]title:@"头条" normalImage:@"01-2" selectedImage:@"01-1"];
    SecondViewController * secondVC=(SecondViewController *)[self creatVCWithClass:[SecondViewController class]title:@"推荐" normalImage:@"02-2.png" selectedImage:@"02-1.png"];
    ThirstViewController * thirstVC=(ThirstViewController *)[self creatVCWithClass:[ThirstViewController class]title:@"电脑" normalImage:@"03-2.png" selectedImage:@"03-1.png"];
    FourViewController * fourVC=(FourViewController *)[self creatVCWithClass:[FourViewController class]title:@"手机" normalImage:@"04-2.png" selectedImage:@"04-1.png"];
