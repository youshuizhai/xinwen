...
-(void)loadDataOfLuBoTu{
    NSString * str=@"http://lib.wap.zol.com.cn/ipj/docList/?v=11.0&class_id=0&page=1&vs=and501&retina=1&modename=M2NOTE";
    //1.生成URL
    ...
    _header =  [XDRefreshHeader headerOfScrollView:self.tableView refreshingBlock:^{
        dispatch_async(dispatch_get_global_queue(0, 0), ^{
            ...
            dispatch_async(dispatch_get_main_queue(), ^{
                ...
                NSString *fileName = [NSString stringWithFormat:@"http://lib.wap.zol.com.cn/ipj/docList/?v=11.0&class_id=0&page=1&vs=and501&retina=1&modename=M2NOTE"];
    ...
    _footer = [XDRefreshFooter footerOfScrollView:self.tableView refreshingBlock:^{
        dispatch_async(dispatch_get_global_queue(0, 0), ^{
            ...
            dispatch_async(dispatch_get_main_queue(), ^{
                ...
                NSString *firstName = [NSString stringWithFormat:@"http://lib.wap.zol.com.cn/ipj/docList/?v=11.0&class_id=0&page=%ld&vs=and501&retina=1&modename=M2NOTE",count];
